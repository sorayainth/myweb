...
<table cellspacing="0" cellpadding="0" class="table">
  ...
  <tr>
    <td width="87"></td>
    <td colspan="10" width="870"> 6. ข้อใดคือคุณสมบัติของรังสี บีตา?</td>
    <td width="87"></td>
  </tr>
  <tr>
    <td></td>
    <td colspan="10"><input type="radio" name="radioexam_6" value="1" id="radioexam_6_1" />
    ก.     เป็นนิวเคลียสของธาตุฮีเลียม    มีประจุไฟฟ้า +2  มีมวล 4u  มีอำนาจทะลุผ่านต่ำ              </td>
    <td></td>
  </tr>
  <tr>
    <td></td>
    <td colspan="10"><input type="radio" name="radioexam_6" value="2" id="radioexam_6_2" />
    ข.      อนุภาคที่มีประจุ -1    มีมวลเท่ากับมวลอิเล็กตรอน มีอำนาจทะลุผ่านปานกลาง                      </td>
    <td></td>
  </tr>
  <tr>
    <td></td>
    <td colspan="10"><input type="radio" name="radioexam_6" value="3" id="radioexam_6_3" />
    ค.     เป็นคลื่นแม่เหล็กไฟฟ้า    มีอำนาจทะลุผ่านมากที่สุด                                                                 </td>
    <td></td>
  </tr>
  <tr>
    <td></td>
    <td colspan="10"><input type="radio" name="radioexam_6" value="4" id="radioexam_6_4" />
